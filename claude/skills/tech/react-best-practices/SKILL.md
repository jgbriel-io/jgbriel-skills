...
description: Apply React 18 + Vite performance best practices — bundle size, re-renders, waterfalls, subscriptions. Use when user asks about React performance, imports, useEffect, or wants a React code review.
---
