...
Read [the GitHub context protocol](references/github-pr.md) and gather the same material as `code-review`: description, linked issues and their comments, relevant specs and plans, commits, diff, complete reviews, general comments, inline discussions with every reply, and checks.
...
- **Leave the thread open for the reviewer to check**, unless resolving it was explicitly requested. Do not dismiss reviews, approve your own work, or merge the PR.
