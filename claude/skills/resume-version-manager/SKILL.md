...
description: Track different resume versions, maintain master resume, manage tailored versions. Use when user has multiple resume versions to manage, or mentions "resume versions", "master resume", "which resume".
---
